...
<html>
<head>
    <title>搜索 - <?php echo ($setting['site_name']); ?></title>
...
<!-- /页头 -->
    ...
    <div class="main">
    <h2 style="font-size:16px;">搜索词：<?php echo ($keyword); ?></h2>
    <div class="shaixuan">
    	<div class="tiaojian">
        	价格：
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>'','from'=>$shaixuan['from'],'discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['price']==''){ ?>class='on'<?php } ?>>不限</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>'asc','from'=>$shaixuan['from'],'discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['price']=='asc'){ ?>class='on'<?php } ?>>从低到高</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>'desc','from'=>$shaixuan['from'],'discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['price']=='desc'){ ?>class='on'<?php } ?>>从高到低</span>
            </a>
        </div>
        <div class="tiaojian">
        	来源：
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>'','discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['from']==''){ ?>class='on'<?php } ?>>不限</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>'tmall','discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['from']=='tmall'){ ?>class='on'<?php } ?>>天猫</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>'taobao','discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['from']=='taobao'){ ?>class='on'<?php } ?>>淘宝</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>'qugoumai','discount'=>$shaixuan['discount']));?>">
            	<span <?php if($shaixuan['from']=='qugoumai'){ ?>class='on'<?php } ?>>其他</span>
            </a>
        </div>
        <div class="tiaojian">
        	折扣：
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>$shaixuan['from'],'discount'=>''));?>">
            	<span <?php if($shaixuan['discount']==''){ ?>class='on'<?php } ?>>不限</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>$shaixuan['from'],'discount'=>'asc'));?>">
            	<span <?php if($shaixuan['discount']=='asc'){ ?>class='on'<?php } ?>>从低到高</span>
            </a>
            <a href="<?php echo U('search/index',array('keywords'=>$keyword,'price'=>$shaixuan['price'],'from'=>$shaixuan['from'],'discount'=>'desc'));?>">
