...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'最后一页','theme'=>'%upPage% %first%  %prePage%  %linkPage% %downPage% %nextPage% %end%');
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    ...
                    $linkPage .= "<li class='active'><a href='javascript:;' style='color:#fff'>".$page."</a></li>";
                }
            }
        }
        $pageStr     =   str_replace(
